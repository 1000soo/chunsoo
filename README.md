...
<body>
    ...
    <script>
        ...
        function item2Rotate() {
            ...
            rotate += 3;
            requestAnimationFrame(item2Rotate);
        ...
        // 네번째 사각형 회전 mouseover, mouseleave
